...
function App() {
  ...
  const removeBodyClasses=()=>{
    document.body.classList.remove('bg-danger','bg-success','bg-warning','bg-#00244a','bg-white','bg-light','bg-dark')
  }
  ...
  return (
    ...
    <div className="App">
      ...
      <Routes>
          ...
          <Route exact path="/Word-and-character-counter" element={<Textbox title="Enter text below:" mode={mode} togglemode={togglemode} theme={theme} check={check} showAlert={showAlert} />}>
        {/* <Textbox title="Enter text below:" mode={mode} showAlert={showAlert}/> */}
          </Route>
          <Route exact path="/" element={<Textbox title="Enter text below:" mode={mode} togglemode={togglemode} theme={theme} check={check} showAlert={showAlert} />}>
        {/* <Textbox title="Enter text below:" mode={mode} showAlert={showAlert}/> */}
          </Route>
        </Routes>
      </div>
